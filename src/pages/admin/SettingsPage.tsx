               ...
               {activeTab === "appearance" && (
                  <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-8">
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
                           ...
                           <div className="cursor-pointer group">
                              <div className="border-2 border-transparent hover:border-[#3e4cf1]/50 rounded-2xl p-2 bg-[#f4f7f6] dark:bg-[#0b0e14]/50 transition-colors">
                              ...
                              <p className="text-center text-[13px] font-bold text-gray-500 mt-3 group-hover:text-[#3e4cf1] transition-colors">Yorug' (Light)</p>
                           </div>

                           {/* Dark Theme Option */}
                           <div className="cursor-pointer group">
                              <div className="border-2 border-[#3e4cf1] rounded-2xl p-2 bg-[#f4f7f6] dark:bg-[#0b0e14]/50 relative transition-colors shadow-[0_0_15px_rgba(62,76,241,0.15)]">
                                 <div className="absolute top-0 right-0 transform translate-x-1/3 -translate-y-1/3 bg-[#3e4cf1] text-white w-6 h-6 rounded-full flex items-center justify-center border-2 border-white dark:border-[#141724]">
                              ...
                              <p className="text-center text-[13px] font-black text-[#141724] dark:text-white mt-3 transition-colors">Tungi (Dark)</p>
                           </div>
                           ...
                           <div className="cursor-pointer group">
                              ...
                              <p className="text-center text-[13px] font-bold text-gray-500 mt-3 group-hover:text-[#3e4cf1] transition-colors">Tizim (Auto)</p>
                           </div>
                     ...
                     <div className="space-y-4 pt-4">
                        ...
                        <div className="flex items-center gap-4">
                           <button className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#3e4cf1] to-indigo-500 shadow-[0_0_15px_rgba(62,76,241,0.4)] flex items-center justify-center border-2 border-white dark:border-[#141724]">
                              <CheckCircle2 className="w-4 h-4 text-white" />
                           </button>
                           <button className="w-10 h-10 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400 hover:scale-110 transition-transform"></button>
                           <button className="w-10 h-10 rounded-full bg-gradient-to-tr from-rose-500 to-pink-500 hover:scale-110 transition-transform"></button>
                           <button className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-500 to-orange-400 hover:scale-110 transition-transform"></button>
                           <button className="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-500 to-fuchsia-400 hover:scale-110 transition-transform"></button>
                        </div>
                     </div>
                  </div>
               )}
